    ...
    public class G_AdvancedData : MonoBehaviour, IMovable, IModifiableState
    {
        ...
        private void Update()
        {
            ...
            if( m_deltaTime > 1f / m_updateRate )
            {
                ...
                m_cameraResolutionText.text
                    = "Render: "
                      + (Camera.main.scaledPixelWidth * dynamicResolutionScale).ToString("0")
                      + "x"
                      + (Camera.main.scaledPixelHeight * dynamicResolutionScale).ToString("0")
                      + "("
                      + (dynamicResolutionScale * 100).ToString("00.0")
                      + "%)"
                      ;
        ...
        public void SetPosition( GraphyManager.ModulePosition newModulePosition, Vector2 offset )
        {
            ...
            switch( newModulePosition )
            {
                ...
                case GraphyManager.ModulePosition.BOTTOM_LEFT:
                    ...
                    m_cameraResolutionText.alignment = TextAnchor.UpperLeft;
                ...
                case GraphyManager.ModulePosition.BOTTOM_RIGHT:
                    ...
                    m_cameraResolutionText.alignment = TextAnchor.UpperRight;
